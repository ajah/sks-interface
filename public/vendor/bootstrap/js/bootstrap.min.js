...
!(function (t, e) {
    ...
    const d = L(r, e.replace(y, '')),
      u = o
        ...
        : (function (t, e) {
            return function i(n) {
              return (
                (n.delegateTarget = t), i.oneOff && j.off(t, n.type, e), e.apply(t, [n])
              )
            }
          })(t, i)
  ...
  class B {
    constructor(t) {
      ;(t = r(t)) &&
        ((this._element = t), H.set(this._element, this.constructor.DATA_KEY, this))
    }
    dispose() {
  ...
  class pt extends B {
    ...
    _getConfig(t) {
      return (
        ((t = { ...rt, ...U.getDataAttributes(this._element), ...t }).toggle = Boolean(
          t.toggle
        )),
        (t.parent = r(t.parent)),
        a(ot, t, at),
        ...
        var n =
            'clippingParents' === e
              ? (function (t) {
                  var e = Ae(Zt(t)),
                    i =
                      ['absolute', 'fixed'].indexOf(Yt(t).position) >= 0 && zt(t)
                        ? te(t)
                        : t
                  return $t(i)
                    ? e.filter(function (t) {
  ...
  function Le(t, e) {
    ...
    var f = u.reduce(function (e, i) {
      return (
        (e[i] = ke(t, { placement: i, boundary: s, rootBoundary: o, padding: r })[Ut(i)]),
        e
      )
    }, {})
