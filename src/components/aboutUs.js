                ...
                <div className="row">
                  <div className="col m-4 text-start fs-6">
                    ...
                    <p className="">
                      ...
                      , was developed as part of the DEAL Strategy, a larger initiative
                      headed by the{' '}
                      <a
                      ...
                      <a href="https://www.otf.ca/">Ontario Trillium Foundation</a>. The{' '}
                      <a href="https://theonn.ca/our-work/data-priorities/deal-strategy/">
                        DEAL (Data, Evidence-use and Learning) Strategy
                      </a>{' '}
                      is exploring different shared approaches to connecting the Ontario
                      nonprofit sector’s data and knowledge to support learning and
                      evidence-informed decision making. The objective of this project is
                      to support better programs and services, public policy development,
                      and outcomes for communities across Ontario.
                    </p>
                    {/* <p className="fw-bold">
                      What is the purpose of the SKS Hub?
                    </p> */}
                    <p className="">
                      <span className="fw-bold">What is the purpose of the SKS Hub?</span>
                      <br />
                      ...
                      for sector leaders, advocates, researchers, and practitioners to
                      search, filter, and navigate it effectively. Our goal is to make
                      this information more accessible to and utilized by the sector. We
                      hope that this prototype will illustrate the benefits of open,
                      shareable and organized data, and allow different stakeholders to
                      better understand the organizations that make up our sector and the
                    ...
                    <ul>
                      <li>
                        <p className="fs-5 my-0">
                          ...
                          Public Foundation, Private Foundation, or Charitable
                          Organization.{' '}
                      ...
                      <li>
                        <p className="fs-5 my-0">
                          ...
                          by organizations in the nonprofit sector.{' '}
                    ...
                    <p>
                      ...
                      <br />
                      The Hub’s data data has been normalized, aggregated, and made
                      available in a public{' '}
                      <a href="https://github.com/ajah/skshub-data">
                        Github repository
                      </a>{' '}
                      stored in 3 separate CSVs. You can also download the data related to
                      a search query directly from the interface by clicking the download
                    ...
                    <p>
                      ...
                      <br />
                      The SKS Hub is a collaborative open project, and we encourage anyone
                      to give us feedback or suggestions on how to make it better. If you
                      would like to talk to us more about this project, have any
                      questions, or would like to discuss how to use the SKS Hub to help
                      your work please <a href="/contact">get in touch with us here</a>.
                      We have created a{' '}
                      <a href="https://github.com/ajah/skshub-data">project on Github</a>{' '}
                      where you can view upcoming updates, features, and known
                      bugs/issues.
                    </p>
                  </div>
                </div>
